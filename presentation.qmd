...
:::{.fragment}
-   **Limitation**
    -   Low-dimensional setting ($p<< n$)
        <!-- -   **Potential features**: Patient demographics, medical history, functional measurements (e.g., six-minute walk test, peak VO2), echocardiographic parameters (e.g., left ventricular ejection fraction), biomarker levels (e.g., NT-proBNP, troponins), etc. -->
:::
...
-   **Objective function** [@zou:2005]:
\begin{align}\label{eq:obj_fun}
