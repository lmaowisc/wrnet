...
Download and compile the R functions from the `wrnet_functions.R` script available at [GitHub](https://github.com/lmaowisc/wrnet).
...
![](images/gbc_cv.png){fig-align="center" width="578"}
